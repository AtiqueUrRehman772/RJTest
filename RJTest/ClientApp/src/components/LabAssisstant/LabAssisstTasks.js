...
export class LabAssisstTask extends Component {
    static displayName = LabAssisstTask.name;
                    ...
                    <div class="row">
                        <div className='imgLogo'>
                            ...
                            <h6 style={{ textAlign: "center" }}>
                                Welcome Lab Assisstant <small>Biit LMS</small>
                            </h6>
                        </div>
                    </div>
                    <hr></hr>
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link">
                                    <span>
                                        <i class="nav-icon fa fa-th"></i>
                                        <Link to="/labadmin/complaints">Complaints</Link>
                                    </span>
